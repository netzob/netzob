...
setup(
    ...
    packages=[
                "src",
                    "src.netzob",
                        "src.netzob.Import",
                            "src.netzob.Import.GOTPoisoning",
                            "src.netzob.Import.TreeViews",
                        "src.netzob.Common",
                            "src.netzob.Common.Models",
                                "src.netzob.Common.Models.Factories",
                        "src.netzob.Export",
                            "src.netzob.Export.TreeViews",
                        "src.netzob.Fuzzing",
                            "src.netzob.Fuzzing.TreeViews",
                        "src.netzob.Modelization",
                            "src.netzob.Modelization.TreeViews",
                ],
