...
class UPGMAClustering(AbstractClusteringAlgorithm):
    ...
    @staticmethod
    def getDefaultSimilarityMeasure():
        return None
    ...
    def __init__(self, similarityMeasure=None, equivalenceThreshold=None):
        super(UPGMAClustering, self).__init__("upgma")
        self.logger = logging.getLogger(__name__)
        if similarityMeasure is None:
            similarityMeasure = UPGMAClustering.getDefaultSimilarityMeasure()
        self.similarityMeasure = similarityMeasure
        if equivalenceThreshold == None:
    ...
    def getConfigurationErrorMessage(self):
        if self.equivalenceThreshold == None:
