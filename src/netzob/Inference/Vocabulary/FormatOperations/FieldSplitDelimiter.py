...
class FieldSplitDelimiter(object):
    ...
    def split(field, delimiter):
        ...
        Source | Destination | Field-0    | Field-sep-6666 | Field-2      | Field-sep-6666 | Field-4
        ------ | ----------- | ---------- | -------------- | ------------ | -------------- | ----------
        None   | None        | 'aaaa'     | 'ff'           | '000000'     | 'ff'           | '10'
        None   | None        | 'bb'       | 'ff'           | '110010'     | 'ff'           | '00000011'
        None   | None        | 'cccccccc' | 'ff'           | 'fe1f000000' | 'ff'           | '12'
        ------ | ----------- | ---------- | -------------- | ------------ | -------------- | ----------
        ...
        >>> print(symbol)# doctest: +NORMALIZE_WHITESPACE
        Source | Destination | Field-0           | Field-sep-5c786666 | Field-2                     | Field-sep-5c786666 | Field-4
        ------ | ----------- | ----------------- | ------------------ | --------------------------- | ------------------ | ------------
        None   | None        | '\\x01\\x02\\x03' | '\\xff'            | '\\x04\\x05'                | '\\xff'            | '\\x06\\x07'
        None   | None        | '\\x01\\x02'      | '\\xff'            | '\\x03\\x04\\x05\\x06'      | '\\xff'            | '\\x07'
        None   | None        | '\\x01'           | '\\xff'            | '\\x02\\x03\\x04\\x05\\x06' | ''                 | ''
        ------ | ----------- | ----------------- | ------------------ | --------------------------- | ------------------ | ------------
