...
import logging
from netzob.UI.Vocabulary.Views.Clustering.UPGMA.UPGMAClusteringConfigurationView import UPGMAClusteringConfigurationView
...
class UPGMAClusteringConfigurationController(object):
    """Controller for the configuration of the UPGMA Clustering process"""
