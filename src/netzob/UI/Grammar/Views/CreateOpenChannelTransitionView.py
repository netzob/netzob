...
class CreateOpenChannelTransitionView(object):
    ...
    def __init__(self, controller, idTransition):
        ...
        self.builder.add_from_file(os.path.join(ResourcesConfiguration.getStaticResources(),
                                                "ui", "grammar",
                                                "createOpenChannelTransition.glade"))
        self._getObjects(self.builder, ["createOpenChannelTransitionDialog",
                                        "createButton", "cancelButton",
                                        "idEntry", "nameEntry", "timeEntry",
                                        "startStateComboBox", "endStateComboBox",
                                        "maxNumberOfAttemptEntry",
                                        "stateListStore",
    ...
    def run(self):
        self.createOpenChannelTransitionDialog.run()

    def destroy(self):
        self.createOpenChannelTransitionDialog.destroy()
