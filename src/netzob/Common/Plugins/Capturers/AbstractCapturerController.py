...
class AbstractCapturerController(AbstractPluginController):
    ...
    def doReadMessages(self):
        raise NotImplementedError("Classes inheriting from AbstractCapturerController must implement the doReadMessages method")

    def doGetMessageDetails(self, messageID):
        raise NotImplementedError("Classes inheriting from AbstractCapturerController must implement the doGetMessageDetails method")

    def doImportMessages(self, selectedMessages):
        raise NotImplementedError("Classes inheriting from AbstractCapturerController must implement the doImportMessages method")
