...
class test_Encoding(NetzobTestCase):
    ...
    # UnitSize.NONE
    def test_HEX(self):
        ff = FormatFunction("Field Format Encoding", Format.HEX, UnitSize.NONE, Endianess.BIG, Sign.UNSIGNED)
    ...
    def test_HEX_BITS4(self):
        ff = FormatFunction("Field Format Encoding", Format.HEX, UnitSize.BITS4, Endianess.BIG, Sign.UNSIGNED)
        res = ff.apply("abcdef")
    ...
    def test_STRING_BITS8(self):
        ff = FormatFunction("Field Format Encoding", Format.STRING, UnitSize.BITS8, Endianess.BIG, Sign.UNSIGNED)
        res = ff.apply("30313233343536373839")
