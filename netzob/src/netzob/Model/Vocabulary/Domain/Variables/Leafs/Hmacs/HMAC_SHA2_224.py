...
class HMAC_SHA2_224(AbstractHMAC):
    r"""This class implements the HMAC_SHA2_224.
    ...
    def calculate(self, msg):
        return hmac.new(self.key, msg=msg, digestmod=hashlib.sha224).digest()

    getBitSize = SHA2_224.getBitSize
