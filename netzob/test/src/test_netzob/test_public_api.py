...
class test_public_api(unittest.TestCase):
    ...
    def test_annotations(self):
        ...
        public_classes = [
            AbstractChannel, AbstractChecksum, AbstractField, AbstractHash, AbstractHMAC, AbstractionLayer, AbstractState, AbstractTransition, AbstractType, Actor, Agg, Alt, Automata, AutomataMutator, BitArray, CloseChannelTransition, Data, DebugChannel, DomainMutator, EmptySymbol, EthernetChannel, Field, Preset, HexaString, Integer, IPChannel, IPv4, Memory, OpenChannelTransition, Opt, Padding, Protocol, Raw, RawEthernetChannel, CustomIPChannel, Repeat, Size, SSLClient, State, String, Symbol, TCPClient, TCPServer, Timestamp, Transition, UDPClient, UDPServer, UnknownSymbol, Value
        ]
